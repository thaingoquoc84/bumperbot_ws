...
class SimpleTFKinematicsNode(Node):
    def __init__(self):
        ...
        self.static_tf_broadcaster_ = StaticTransformBroadcaster(self) #Tao pub tinh
        self.dynamic_tf_broadcaster_ = TransformBroadcaster(self) #Pub dong
        ...
        self.static_tf_broadcaster_.sendTransform(self.static_transform_stamped_) #Publish
    ...
    def timerCallback(self):
        ...
        self.static_transform_stamped_.transform.rotation.x = q[0]
        self.static_transform_stamped_.transform.rotation.y = q[1]
        self.static_transform_stamped_.transform.rotation.z = q[2]
        self.static_transform_stamped_.transform.rotation.w = q[3]
