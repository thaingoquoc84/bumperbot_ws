...
class SimpleControllerNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("The matrix conversion is: %s" % self.speed_conversion_)
    def velCallback(self, msg: TwistStamped):
        ...
        wheel_speed_msg_ = Float64MultiArray()
        wheel_speed_msg_.data = [wheel_speed_[1, 0], wheel_speed_[0, 0]]
        self.wheel_cmd_pub_.publish(wheel_speed_msg_)
